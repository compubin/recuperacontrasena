	...
	else
	{
		...
		{			
			...
			$message = "					
						...
						<br /><br />
						<a href='http://localhost:81/olvide_mi_contrasena/verify.php?id=$id&code=$code'>Click HERE to Activate :)</a>
						<br /><br />
						Thanks,";
			...
			$msg = "
					<div class='alert alert-success'>
						<button class='close' data-dismiss='alert'>&times;</button>
						<strong>Success!</strong> Hemos enviado un correo electrónico a $email.
